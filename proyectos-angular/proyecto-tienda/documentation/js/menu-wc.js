...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">proyecto-tienda documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            <li class="link">
                                <a href="components/AccountsManagementComponent.html" data-type="entity-link" >AccountsManagementComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/ProductsManagementComponent.html" data-type="entity-link" >ProductsManagementComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/RegisterComponent.html" data-type="entity-link" >RegisterComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/RolesManagementComponent.html" data-type="entity-link" >RolesManagementComponent</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
